...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<meta charset="UTF-8">
	<meta name="description" content="Basic Fantasy RPG Magic-User Character Generator. Goblinoid Games.">
	...
	*/
	function Character() {
		...
		let magic_userCharacter = {
            ...
            "speed": encumberanceMove (ltLoad, encumberance) + "'",
