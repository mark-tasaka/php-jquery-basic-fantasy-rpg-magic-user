...
<html>
<head>
<title>Launch Page: Basic Fantasy RPG Magic-User Generator</title>
	...
	<section>
		...
		<form action="" id ="magic_userForm"  target="_blank" method="post">
            ...
            <div id="weaponsGroupings">
                ...
                <input type="checkbox" name="theWeapons[]" value="15"> Walking Stick<br/>
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#magic_userForm").attr('action', "character/basic_magic_user" + $("#abilityScores").val() +  ".php");
